<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand brand-logo" href="{{ route('showdoctor') }}"><img src="{{ asset('admin/assets/images/logo.svg') }}" alt="logo" /></a>
    <a class="sidebar-brand brand-logo-mini" href="{{ route('showdoctor') }}"><img src="{{ asset('admin/assets/images/logo-mini.svg') }}" alt="logo" /></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="{{ url('/medicaldevice') }}">
        <span class="menu-icon">
          <i class="mdi mdi-file-document-box"></i>
        </span>
